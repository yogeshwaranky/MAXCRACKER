...
const categoryFilter = queryParams.get("category"); // Get category from URL

const [filteredProducts, setFilteredProducts] = useState(CrackersList);
...
useEffect(() => {
  if (categoryFilter) {
    const filtered = CrackersList.filter(
      (item) => item.productType.toLowerCase() === categoryFilter.toLowerCase()
    );
    setFilteredProducts(filtered);
  } else {
    setFilteredProducts(CrackersList);
  }
}, [categoryFilter]);
